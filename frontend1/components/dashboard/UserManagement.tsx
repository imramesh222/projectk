    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900">22,150</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900">2,570</div>
            <p className="text-xs text-green-600 mt-1">+18.9% from last month</p>
          </CardContent>
        </Card>
      </div>
