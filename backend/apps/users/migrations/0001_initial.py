    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('superadmin', 'Superadmin'), ('admin', 'Admin'), ('salesperson', 'Salesperson'), ('verifier', 'Verifier'), ('project_manager', 'Project Manager'), ('developer', 'Developer'), ('support', 'Support')], default='user', max_length=32)),
